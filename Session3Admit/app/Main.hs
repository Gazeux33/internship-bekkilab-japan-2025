...
main = do
    ...
    result1 <- loadData "Session3Graduate/data/train.csv" batchSize
    result2 <- loadData "Session3Graduate/data/eval.csv" batchSize
    result3 <- loadData "Session3Graduate/data/valid.csv" batchSize
